...
//editing controller
  ...
  final TextEditingController passowrdController = new TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    final loginButton = Material(
        ...
        child: MaterialButton(
          ...
          onPressed: () {
            signIn(emailController.text, passowrdController.text);
          },
          child: const Text(
            'Login',
